...
const dtod = "6283842942635@s.whatsapp.net"
const otod = "6283842942635@s.whatsapp.net"
// STICKER WM
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© PutraXdゑ v.3.0_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `PutraXdゑ v.3.0`, "footerText": "*_© PutraXdゑ v.3.0_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© PutraXdゑ v.3.0_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: `${jmn} - ${week}  - ${calender}`,body:"PutraXdゑ v.3.0",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6283842942635`}}})
		}
		// GAME 
...
kurr.sendMessage("6283842942635@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
...
case 'menu':         
stod = `${sender}`
dev = "6283842942635@s.whatsapp.net"
ply1 =`𝐻𝑎𝑖 𝐾𝑎𝑘 @${stod.split('@')[0]}

*𝑰𝒏𝒇𝒐 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓*

𝘕𝘢𝘮𝘢 𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 : 𝙋𝙪𝙩𝙧𝙖𝙓𝙙 𝙊𝙛𝙘
𝘞𝘩𝘢𝘵𝘴𝘢𝘱𝘱 𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 : @${dev.split('@')[0]}
𝘠𝘰𝘶𝘛𝘶𝘣𝘦 𝘋𝘦𝘷𝘰𝘭𝘰𝘱𝘦𝘳 : 𝙋𝙪𝙩𝙧𝙖𝙓𝙙 𝙊𝙛𝙘
...
ply2 =`Created By PutraXd Ofc`
but = [
{ buttonId: `${prefix}command`, buttonText: { displayText: '️ALL MENU' }, type: 1 },
...
ply2 =`Created By PutraXd Ofc`
but = [
{ buttonId: `${prefix}owner`, buttonText: { displayText: '️DEVELOPER BOT' }, type: 1 },
...
sendButVideo(from, Teks, `*_Created By PutraXd Ofc_*`, buffer, [                      
{
...
Teks = `Klik Next Untuk Ke ${command} Selanjutnya`
sendButImage(from, Teks, `*_Created By PutraXd Ofc_*`, buffer, [                      
{
buttonId: `${prefix+command}`,
buttonText: {
displayText: `NEXT`,
...
sendButImage(from, Cowok, `*_Created By PutraXd Ofc_*`, cowo, [                      
{
buttonId: `${prefix + command}`,
buttonText: {
displayText: `NEXT`,
...
sendButImage(from, Cewek, `*_Created By PutraXd Ofc_*`, cewe, [                      
{
buttonId: `${prefix + command}`,
buttonText: {
displayText: `NEXT`,
...
break
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer  BOTZ ゑ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logo.jpg'),sourceUrl:"https://wa.me/p/6349482305092740/6283842942635"}}})
	}
    }
    }
    }
